...
- `sender` _TEXT_ - The account sending VTM
- `recipient` _TEXT_ - The account receiving VTM
- `amount` _UINT_ - The amount of VTM to send
...
## Example
Transfer 1000 VTM from **inita** to **tester**

```sh
vectrum-cli transfer inita tester 1000
```
