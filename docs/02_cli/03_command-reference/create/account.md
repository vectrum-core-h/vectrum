...
## Command
A set of VECTRUM keys is required to create an account. The VECTRUM keys can be generated by using `vectrum-cli create key`.

```sh
vectrum-cli create account inita tester EOS4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq EOS7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
