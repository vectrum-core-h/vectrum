...
```sh
# command-line
vectrum-node ... --plugin eosio::state_history_plugin [operations] [options]
```

## Operations

These can only be specified from the `vectrum-node` command-line:
...
### history-tools
  ...
  * [Source code](https://github.com/vectrum-core/history-tools/)
...
```sh
# command-line
vectrum-node ... --plugin eosio::chain_plugin --disable-replay-opts
```
