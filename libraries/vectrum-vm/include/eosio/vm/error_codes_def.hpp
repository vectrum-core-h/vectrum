...
GENERATE_ERROR_CATEGORY(parser_errors, "vectrum-vm parser errors")
GENERATE_ERROR_CATEGORY(memory_errors, "vectrum-vm memory errors")
GENERATE_ERROR_CATEGORY(system_errors, "vectrum-vm system errors")
GENERATE_ERROR_CATEGORY(auxiliary_errors, "vectrum-vm auxiliary errors")
