   ...
   void net_plugin::set_program_options( options_description& /*cli*/, options_description& cfg )
   {
      cfg.add_options()
         ...
         ( "p2p-peer-address", bpo::value< vector<string> >()->composing(),
           ...
           "  Examples:\n"
           "    p2p.vectrum.group:9876\n"
           "    p2p.trx.vectrum.group:9876:trx\n"
           "    p2p.blk.vectrum.group:9876:blk\n")
         ...
         ( "agent-name", bpo::value<string>()->default_value("\"VECTRUM Agent\""), "The name supplied to identify this node amongst the peers.")
